...
var testForeignObject = function testForeignObject(document) {
    ...
    img.src = 'data:image/svg+xml,<svg xmlns=\'http://www.w3.org/2000/svg\'><foreignObject><img src="' + encodeURIComponent(canvas.toDataURL()) + '" /></foreignObject></svg>';
    ...
    _createClass(ImageLoader, [{
        ...
        value: function xhrImage(src) {
            ...
            this.cache[src] = new Promise(function (resolve, reject) {
                ...
                return loadImage(src, _this.options.imageTimeout || 0);
            });
...
var loadImage = function loadImage(src, timeout) {
    return new Promise(function (resolve, reject) {
        var img = new Image();
        img.onload = function () {
            return resolve(img);
                ...
                if (node instanceof HTMLImageElement) {
                    this.imageLoader.inlineImage(node.src).then(function (img) {
                        if (img && node instanceof HTMLImageElement && node.parentNode) {
                            node.parentNode.replaceChild((0, _Util.copyCSSStyles)(node.style, img.cloneNode(false)), node);
                        }
                    });
                }
            }
